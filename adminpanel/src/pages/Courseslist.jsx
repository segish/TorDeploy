                ...
                : error ? <TableRow><TableCell colSpan={9}><div className="flex items-center justify-center w-full"><div className="text-red-700">somthing went wrong!</div></div></TableCell></TableRow>
                  : data?.map((row, index) => (
                    <TableRow
                      ...
                      <TableCell className=' dark:text-gray-200 dark:bg-slate-950 '><Link to={"/chapters?id=" + row._id}><div className="" > +<EditIcon className="w-3 h-1" /> {row.section.length}</div></Link></TableCell>
