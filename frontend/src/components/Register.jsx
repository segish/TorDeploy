...
const Register = ({ setRegister }) => {
    ...
    return (
        <>
            <div class="sticky h-[95%] pt-3 lg:ml-[35%] opacity-100 ">
                <div className="absolute md:w-[380px] h-[100%] overflow-y-auto inset-[4px] bg-white dark:border dark:bg-black p-[40px] rounded-lg flex flex-col" id="otpbox">
